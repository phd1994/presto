...
import com.facebook.presto.execution.scheduler.RefreshingNodeMapSupplierProvider;
...
public class TestNodeScheduler
{
            ...
            throws Exception
    {
        ...
        NodeScheduler nodeScheduler = new NodeScheduler(locationCache, topology, nodeManager, nodeSchedulerConfig, nodeTaskMap, new RefreshingNodeMapSupplierProvider());
